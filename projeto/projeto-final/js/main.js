...
//Abrindo e Fechando o Modal de musica
for (var i = 0; i < toggleModal.length; i++) {
    toggleModal[i].addEventListener('click', function () {
        var modalAlbum = document.querySelector('#jl-modal-album');
        var overlay = document.querySelector('.jl-overlay');
        overlay.classList.toggle('jl-is-open');
        modalAlbum.classList.toggle('jl-is-open');
        modalAlbum.classList.toggle('jl-slide-top-in');
    });
}
