...
var sliderItem = document.querySelectorAll('.jl-album-item');
...
var setActiveSlide = function () {
    for (var sld = 0; sld < sliderItem.length; sld++) {
        ...
        if (mySlideNum === currentCounter) {
            ...
            sliderItem[sld].querySelector('.jl-album-item-box').classList.add('jl-scale-right');
            sliderItem[sld].querySelector('.jl-album-item-thumb img').classList.add('jl-scale-up');
            sliderItem[sld].querySelector('.jl-album-item-info').classList.add('jl-fade-from-left');
        }
    }
}
...
var changeActive = function () {
    ...
    for (var rms = 0; rms < sliderItem.length; rms++) {
        ...
        sliderItem[rms].querySelector('.jl-album-item-box').classList.remove('jl-scale-right');
        sliderItem[rms].querySelector('.jl-album-item-thumb img').classList.remove('jl-scale-up');
        sliderItem[rms].querySelector('.jl-album-item-info').classList.remove('jl-fade-from-left');
    }
    setActiveNav();
    setActiveSlide();
}
